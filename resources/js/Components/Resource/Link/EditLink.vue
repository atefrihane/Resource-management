<template>
  ...
  <div class="flex justify-center">
    ...
    <Success
      v-if="success"
      :successMessage="'Link resource updated..'"
...
export default {
  ...
  data() {
    return {
      ...
      url: this.resource.type.url,
      open_tab: this.resource.type.open_tab == 1 ? true : false,
      errors: {},
      success: false,
    };
  },
  ...
  methods: {
    updateUrl() {
      axios
        .put(`/api/resource/link/${this.resource.id}/update`, {
          title: this.title,
          url: this.url,
